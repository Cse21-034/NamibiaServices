    ...
    <div className="min-h-screen bg-white dark:bg-gray-950">
      ...
      <div className="relative w-full h-64 md:h-96 lg:h-[500px] overflow-hidden bg-gray-200 dark:bg-gray-800">
        {hasImage ? (
          ...
          <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-[#f7b717]/20 to-blue-500/20 dark:from-[#f7b717]/10 dark:to-blue-500/10">
              ...
              <div className="rounded-2xl bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 border-2 border-gray-200 dark:border-gray-700 shadow-xl p-8 space-y-6">
                ...
                {businessId && (
                  <Link href={`/business/${businessId}`} className="block">
                    <button className="w-full py-4 px-4 bg-gradient-to-r from-[#f7b717] to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-white font-bold rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105">
                      View Full Profile
                    </button>
                  </Link>
                )}
